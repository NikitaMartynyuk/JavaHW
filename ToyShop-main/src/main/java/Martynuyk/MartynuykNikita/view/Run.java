public class Run {
    final String FILE_NAME_TOYS = "./src/main/java/Martynuyk/MartynuykNikita/db/toys.csv";
    final String FILE_NAME_BUYERS = "./src/main/java/Martynuyk/MartynuykNikita/db/buyers.csv";
    final String PRIZE_TOY = "../src/main/java/Martynuyk/MartynuykNikita/db/PrizeToyList.csv";
    final String AWARDED_TOY = "./src/main/java/Martynuyk/MartynuykNikita/db/AwardedToyFromByuers.csv";
